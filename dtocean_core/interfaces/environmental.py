...
class EnvironmentalInterface(ThemeInterface):
    ...
    def declare_inputs(cls):
        ...
        input_list  =  ["device.system_type",
                        ...
                        "farm.installation_journeys",
                        "farm.installation_vessel_average_size",
                        "farm.operation_journeys",
                        "farm.operation_vessel_average_size",
                        "farm.direction_of_max_surface_current", 
                        "farm.resource_reduction",
                        "farm.initial_turbidity",
                        "farm.hydro_measured_turbidity",
                        "farm.install_measured_turbidity",
                        "farm.operat_measured_turbidity",
                        "farm.initial_noise",
                        "farm.hydro_measured_noise",
                        "farm.elec_measured_noise",
                        "farm.moor_measured_noise", 
                        "farm.install_measured_noise",
                        "farm.operat_measured_noise",
                        "farm.initial_elec_field",
                        "farm.elec_measured_elec_field",
                        "farm.initial_magnetic_field",
                        "farm.elec_measured_magnetic_field",
                        "farm.initial_temperature",
                        "farm.elec_measured_temperature",
                        "farm.install_import_chem_pollutant",
                        "farm.operat_import_chem_pollutant",
...
#                        "farm.receptors_electrosensitive_species",
                        ...
                        "farm.hydro_underwater_noise_risk_weight",
                        "farm.hydro_reserve_effect_weight",
                        "farm.hydro_reef_effect_weight",
                        "farm.hydro_resting_place_weight",
                        "farm.elec_collision_risk_weight",
                        "farm.elec_elec_field_weight",
                        "farm.elec_footprint_weight",
                        "farm.elec_magnetic_field_weight",
                        "farm.elec_reef_effect_weight",
                        "farm.elec_reserve_effect_weight",
                        "farm.elec_resting_place_weight",
                        "farm.elec_temp_modif_weight",
                        "farm.elec_underwater_noise_risk_weight", 
                        "farm.moor_collision_risk_weight",
                        "farm.moor_footprint_weight",
                        "farm.moor_reef_effect_weight",
                        "farm.moor_underwater_noise_risk_weight",
                      
                        "farm.install_collision_risk_weight",
                        "farm.install_footprint_weight",
                        "farm.install_turbidity_risk_weight",
                        "farm.install_chemical_pollution_weight",
                        "farm.install_underwater_noise_risk_weight",
                        
                        "farm.operat_collision_risk_weight",
                        "farm.operat_footprint_weight",
                        "farm.operat_turbidity_risk_weight",
                        "farm.operat_chemical_pollution_weight",
                        "farm.operat_underwater_noise_risk_weight",
    ...
    def declare_outputs(cls):
        ...
        output_list = ["farm.global_eis",
                       'farm.hydro_global_eis',
                       'farm.hydro_eis',
                       'farm.hydro_confidence',
                       'farm.hydro_season',
                       'farm.hydro_recommendation_dict',
                       'farm.elec_global_eis',
                       'farm.elec_eis',
                       'farm.elec_confidence',
                       'farm.elec_season',
                       'farm.elec_recommendation_dict',
                       'farm.moor_global_eis',
                       'farm.moor_eis',
                       'farm.moor_confidence',
                       'farm.moor_season',
                       'farm.moor_recommendation_dict',
                       'farm.install_global_eis',
                       'farm.install_eis',
                       'farm.install_confidence',
                       'farm.install_season',
                       'farm.install_recommendation_dict',
                       'farm.operat_global_eis',
                       'farm.operat_eis',
                       'farm.operat_confidence',
                       'farm.operat_season',
                       'farm.operat_recommendation_dict',                       
                       ]
...
#                    "farm.receptors_electrosensitive_species",
    ...
    def declare_id_map(self):
        ...
        id_map = { "device_type" : "device.system_type",
                   ...
                   "hydro_underwater_noise_risk_weight" : "farm.hydro_underwater_noise_risk_weight",
                   "hydro_reserve_effect_weight" : "farm.hydro_reserve_effect_weight",
                   "hydro_reef_effect_weight" : "farm.hydro_reef_effect_weight",
                   "hydro_resting_place_weight" : "farm.hydro_resting_place_weight",
                   "resource_reduction" : "farm.resource_reduction",
                   "layout" : "farm.layout",
                   "initial_turbidity" : "farm.initial_turbidity",
                   "hydro_measured_turbidity" : "farm.hydro_measured_turbidity",
                   "initial_noise" : "farm.initial_noise",
                   "hydro_measured_noise" : "farm.hydro_measured_noise",
                   "number_of_devices" : "farm.number_of_devices",
                   "device_draft" : "device.system_draft",
                   "device_width" : "device.system_width",
                   "current_direction" : "farm.direction_of_max_surface_current",
                   "fishery_restricted_area" : "farm.fishery_restricted_area",
                   "lease_boundary" : "site.lease_boundary",
                   "strata" : "bathymetry.layers", 
                   "hydro_confidence" : "farm.hydro_confidence",
                   "hydro_eis" : "farm.hydro_eis",
                   "hydro_season" : "farm.hydro_season",
                   "hydro_recommendation_dict" : "farm.hydro_recommendation_dict",
                   "hydro_global_eis" : "farm.hydro_global_eis",
                   "elec_global_eis" : "farm.elec_global_eis",
                   "moor_global_eis" : "farm.moor_global_eis",
                   "elec_confidence" : "farm.elec_confidence",
                   "elec_eis" : "farm.elec_eis",
                   "elec_season" : "farm.elec_season",
                   "elec_recommendation_dict" : "farm.elec_recommendation_dict",
                   "device_height" : "device.system_height",
                   "device_length" : "device.system_length",
                   "elec_collision_risk_weight" : "farm.elec_collision_risk_weight",
                   "elec_elec_field_weight" : "farm.elec_elec_field_weight",
                   "elec_footprint_weight" : "farm.elec_footprint_weight",
                   "elec_magnetic_field_weight" : "farm.elec_magnetic_field_weight",
                   "elec_reef_effect_weight" : "farm.elec_reef_effect_weight",
                   "elec_reserve_effect_weight" : "farm.elec_reserve_effect_weight",
                   "elec_resting_place_weight" : "farm.elec_resting_place_weight",
                   "elec_temp_modif_weight" : "farm.elec_temp_modif_weight",
                   "elec_underwater_noise_risk_weight" : "farm.elec_underwater_noise_risk_weight",
                   "elec_measured_noise" :"farm.elec_measured_noise",
                   "initial_elec_field" : "farm.initial_elec_field",
                   "elec_measured_elec_field" : "farm.elec_measured_elec_field",
                   "initial_magnetic_field" : "farm.initial_magnetic_field",
                   "elec_measured_magnetic_field" : "farm.elec_measured_magnetic_field",
                   "initial_temperature" : "farm.initial_temperature",
                   "elec_measured_temperature" : "farm.elec_measured_temperature",
                   "substation_props" : "farm.substation_props",
                   "substation_layout" : "farm.substation_layout",
                   "moor_collision_risk_weight" : "farm.moor_collision_risk_weight",
                   "moor_footprint_weight" : "farm.moor_footprint_weight",
                   "moor_reef_effect_weight" : "farm.moor_reef_effect_weight",
                   "moor_underwater_noise_risk_weight" : "farm.moor_underwater_noise_risk_weight",
                   "moor_measured_noise" : "farm.moor_measured_noise",
                   "moor_confidence" : "farm.moor_confidence",
                   "moor_eis" : "farm.moor_eis",
                   "moor_season" : "farm.moor_season",
                   "moor_recommendation_dict" : "farm.moor_recommendation_dict",
                   "moorings_dimensions" : "farm.moorings_dimensions",
                   "number_vessels" : "farm.installation_journeys",
                   "average_size_vessels_inst" : "farm.installation_vessel_average_size",
                   "install_import_chem_pollutant" : "farm.install_import_chem_pollutant",
                   
                   "install_collision_risk_weight" : "farm.install_collision_risk_weight",
                   "install_footprint_weight" : "farm.install_footprint_weight",
                   "install_turbidity_risk_weight" : "farm.install_turbidity_risk_weight",
                   "install_chemical_pollution_weight" : "farm.install_chemical_pollution_weight",
                   "install_underwater_noise_risk_weight" : "farm.install_underwater_noise_risk_weight",
                   "install_measured_noise" : "farm.install_measured_noise", 
                   "install_measured_turbidity" : "farm.install_measured_turbidity",
                   "install_eis" : "farm.install_eis", 
                   "install_confidence" : "farm.install_confidence",
                   "install_global_eis" : "farm.install_global_eis",
                   "install_recommendation_dict" : "farm.install_recommendation_dict",
                   "install_season" : "farm.install_season",
                   
                   "operat_import_chem_pollutant" : "farm.operat_import_chem_pollutant",
                   "operat_collision_risk_weight" : "farm.operat_collision_risk_weight",
                   "operat_footprint_weight" : "farm.operat_footprint_weight",
                   "operat_turbidity_risk_weight" : "farm.operat_turbidity_risk_weight",
                   "operat_chemical_pollution_weight" : "farm.operat_chemical_pollution_weight",
                   "operat_underwater_noise_risk_weight" : "farm.operat_underwater_noise_risk_weight",
                   "operat_measured_noise" : "farm.operat_measured_noise", 
                   "operat_measured_turbidity" : "farm.operat_measured_turbidity",
                   "operat_eis" : "farm.operat_eis", 
                   "operat_confidence" : "farm.operat_confidence",
                   "operat_global_eis" : "farm.operat_global_eis",
                   "operat_recommendation_dict" : "farm.operat_recommendation_dict",
                   "operat_season" : "farm.operat_season",
                   
                   "operat_number_vessels" : "farm.operation_journeys",
                   "operat_average_size_vessels" : "farm.operation_vessel_average_size",
