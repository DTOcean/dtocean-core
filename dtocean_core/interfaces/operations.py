...
class OperationsInterface(ModuleInterface):
    ...
    def declare_inputs(cls):
        ...
        input_list  =  [
                        "farm.calendar_based_maintenance",
                        "farm.condition_based_maintenance",
                        "farm.corrective_maintenance",
                        "farm.duration_shift",
                        "farm.helideck",
                        "farm.number_crews_available",
                        "farm.number_crews_per_shift",
                        "farm.number_shifts_per_day",
                        "farm.wage_specialist_day",
                        "farm.wage_specialist_night",
                        "farm.wage_technician_day",
                        "farm.wage_technician_night",
                        "farm.workdays_summer",
                        "farm.workdays_winter",
                        ...
                        'device.pto_operations_weighting',
                        'device.control_operations_weighting',
                        'device.support_operations_weighting',
                        'farm.umbilical_operations_weighting',
                        'farm.array_cables_operations_weighting',
                        'farm.substations_operations_weighting',
                        'farm.export_cable_operations_weighting',
                        'farm.foundations_operations_weighting',
                        'farm.moorings_operations_weighting',

                        'device.subsystem_failure_rates',
                        'farm.electrical_subsystem_failure_rates',
                        'farm.moorings_subsystem_failure_rates',
                        ...
                        'farm.electrical_replacement_requirements',
                        'farm.moorings_replacement_requirements',
                        ...
                        'farm.moorings_onsite_maintenance_parts',
                        'device.replacement_parts',
                        'farm.electrical_replacement_parts',
                        'farm.moorings_replacement_parts',

                        'device.subsystem_lead_times',
                        'farm.electrical_subsystem_lead_times',
                        'farm.moorings_subsystem_lead_times',
                        
                        'device.subsystem_costs',
                        'farm.moorings_subsystem_costs',
                        ...
                        'component.fuel_cost_rate',
                        'component.grout_rate',
                        'component.hammer',
                        'component.hammer_safety_factors',
                        'component.installation_soil_compatibility',
                        'component.loading_rate',
                        'component.mattress_installation',
                        'component.port_locations',
                        'component.port_safety_factors',
                        'component.ports',
                        'component.power_quality',
                        'component.rock_bags_installation',
                        'component.rov',
                        'component.rov_safety_factors',
                        'component.split_pipe_laying_rate',
                        'component.split_pipe_safety_factors',
                        'component.split_pipes_installation',
                        'component.static_cable',
                        'component.surface_laying_rate',
                        'component.switchgear',
                        'component.transformers',
                        'component.vessel_safety_factors',
                        'component.vessels',
                        'component.vibro_driver',
                        'component.vibro_driver_safety_factors',
                        'component.wet_mate_connectors',
                        'corridor.landfall_contruction_technique',
                        'corridor.layers',
    ...
    def declare_outputs(cls):
        ...
        output_list = ["farm.capex_oandm",
                       "farm.lifetime_energy",
                       "farm.lifetime_opex",
                       "farm.array_downtime",
                       "farm.array_availability",
                       "farm.downtime_per_device",
                       "farm.lifetime_energy_per_device",
                       "farm.uptime_series",
                       "farm.opex_per_year",
                       "farm.energy_per_year",
                       "farm.calendar_maintenance_events",
                       "farm.condition_maintenance_events",
                       "farm.corrective_maintenance_events",
    ...
    def declare_optional(cls):
        ...
        options_list = ['farm.electrical_replacement_requirements',
                        'farm.moorings_replacement_requirements',
                        'farm.electrical_inspections_requirements',
                        'farm.moorings_inspections_requirements',
                        'farm.electrical_replacement_parts',
    ...
    def declare_id_map(self):
        ...
        id_map = {  
            "calendar_based_maintenance": "farm.calendar_based_maintenance",
            "condition_based_maintenance": "farm.condition_based_maintenance",
            "corrective_maintenance": "farm.corrective_maintenance",
            "duration_shift": "farm.duration_shift",
            "helideck": "farm.helideck",
            "number_crews_available": "farm.number_crews_available",
            "number_crews_per_shift": "farm.number_crews_per_shift",
            "number_shifts_per_day": "farm.number_shifts_per_day",
            "wage_specialist_day": "farm.wage_specialist_day",
            "wage_specialist_night": "farm.wage_specialist_night",
            "wage_technician_day": "farm.wage_technician_day",
            "wage_technician_night": "farm.wage_technician_night",
            "workdays_summer": "farm.workdays_summer",
            "workdays_winter": "farm.workdays_winter",
            "energy_selling_price": "project.energy_selling_price",
            
            "system_type": "device.system_type",
            "network_type": "farm.network_configuration",
            "array_layout": "farm.layout",
            ...
            "moor_bom": "farm.moorings_foundations_economics_data",
            ...
            "device_failure_rates": 'device.subsystem_failure_rates',
            "electrical_failure_rates":
                'farm.electrical_subsystem_failure_rates',
            "moorings_failure_rates": 'farm.moorings_subsystem_failure_rates',
            ...
            'electrical_replacement_parts':
                'farm.electrical_replacement_parts',
            'moorings_replacement_parts': 'farm.moorings_replacement_parts',
#            
            ...
            'moorings_subsystem_costs': 'farm.moorings_subsystem_costs',
            ...
            'cable_burial_safety_factors':
                'component.cable_burial_safety_factors',
            'cable_routes': 'farm.cable_routes',
            'cable_tool': 'farm.selected_installation_tool',
            'commission_time': 'project.comissioning_time',
            ...
            'divers_safety_factors': 'component.divers_safety_factors',
            ...
            'electrical_components': 'farm.electrical_component_data',
            'entry_point': 'farm.entry_point',
            'excavating': 'component.excavating',
            'export': 'corridor.layers',
            'foundation_soil_layers': 'farm.foundations_soil_data',
            'foundations_data': 'farm.foundations_component_data',
            'fuel_cost_rate': 'component.fuel_cost_rate',
            'grout_rate': 'component.grout_rate',
            'hammer': 'component.hammer',
            'hammer_safety_factors': 'component.hammer_safety_factors',
            ...
            'installation_soil_compatibility':
                'component.installation_soil_compatibility',
            'landfall': 'corridor.landfall_contruction_technique',
            'lease_utm_zone': 'site.projection',
            'line_component_data': 'farm.moorings_component_data',
            'line_summary_data': 'farm.line_data',
            'load_out_method': 'device.load_out_method',
            'loading_rate': 'component.loading_rate',
            ...
            'port_safety_factors': 'component.port_safety_factors',
            'ports': 'component.ports',
            'project_start_date': 'project.start_date',
            'rock_bags': 'component.rock_bags_installation',
            'rov': 'component.rov',
            'rov_safety_factors': 'component.rov_safety_factors',
            'split_pipe_laying_rate': 'component.split_pipe_laying_rate',
            'split_pipe_safety_factors': 'component.split_pipe_safety_factors',
            'split_pipes': 'component.split_pipes_installation',
            'sub_device': 'device.sub_systems_installation',
            'substations': 'farm.substation_props',
            'surface_laying_rate': 'component.surface_laying_rate',
            ...
            'umbilical_terminations': 'farm.umbilical_seabed_connection',
            'umbilicals': 'farm.umbilical_cable_data',
            'vessel_safety_factors': 'component.vessel_safety_factors',
            ...
            "annual_energy_per_device": "farm.annual_energy_per_device",
            "mean_power_per_device": "farm.mean_power_per_device",
            ...
            "lifetime_energy": "farm.lifetime_energy",
            "lifetime_opex": "farm.lifetime_opex",
            "downtime_per_device": "farm.downtime_per_device",
            "energy_per_device": "farm.lifetime_energy_per_device",
            "array_downtime": "farm.array_downtime",
            "array_availability": "farm.array_availability",
            "uptime_series": "farm.uptime_series",
            "opex_per_year": "farm.opex_per_year",
            "energy_per_year": "farm.energy_per_year",
            "calendar_maintenance_events": "farm.calendar_maintenance_events",
            "condition_maintenance_events":
                "farm.condition_maintenance_events",
            "corrective_maintenance_events":
                "farm.corrective_maintenance_events",
            "journeys": "farm.operation_journeys"
            }
...
#                requires_divers (bool) [-]          : Are divers required?
        ...
        (component_df,
         ...
         inspection_df) = get_input_tables(
                                ...
                                self.data.support_operations_weighting,
                                ...
                                self.data.device_failure_rates,
