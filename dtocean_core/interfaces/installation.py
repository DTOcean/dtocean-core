...
class InstallationInterface(ModuleInterface):
    ...
    def declare_inputs(cls):
        ...
        input_list  =  ["component.rov",
                        ...
                        MaskVariable("farm.umbilical_cable_data",
                                      'device.system_type',
                        ...
                        MaskVariable("farm.line_data",
                                      'device.system_type',
                                      ['Tidal Floating', 'Wave Floating']),
                        MaskVariable("farm.moorings_component_data",
                                      'device.system_type',
                                      ['Tidal Floating', 'Wave Floating']),
    ...
    def declare_outputs(cls):
        ...
        output_list = ["project.installation_completion_date",
                       ...
                       "farm.device_phase_installation_costs",
                       "farm.device_phase_installation_cost_breakdown",
                       "farm.device_phase_cost_class_breakdown",
                       "farm.device_phase_installation_times",
                       "farm.device_phase_installation_time_breakdown",
                       "farm.device_phase_time_class_breakdown",
                       "farm.electrical_phase_installation_costs",
                       "farm.electrical_phase_installation_cost_breakdown",
                       "farm.electrical_phase_cost_class_breakdown",
                       "farm.electrical_phase_installation_times",
                       "farm.electrical_phase_installation_time_breakdown",
                       "farm.electrical_phase_time_class_breakdown",
                       "farm.mooring_phase_installation_costs",
                       "farm.mooring_phase_installation_cost_breakdown",
                       "farm.mooring_phase_cost_class_breakdown",
                       "farm.mooring_phase_installation_times",
                       "farm.mooring_phase_installation_time_breakdown",
                       "farm.mooring_phase_time_class_breakdown",
                       "farm.installation_phase_cost_breakdown",
                       "farm.installation_cost_class_breakdown",
                       "farm.total_installation_cost",
                       "farm.installation_phase_time_breakdown",
                       "farm.installation_time_class_breakdown",
                       "farm.total_installation_time",
    ...
    def declare_optional(cls):
        ...
        optional = ["farm.electrical_network",
                    "farm.electrical_component_data",
                    "farm.cable_routes",
                    "farm.substation_props",
    ...
    def declare_id_map(self):
        ...
        id_map = {"rov": "component.rov",
                  ...
                  "mf_network": "farm.moorings_foundations_network",
                  ...
                  "port": "farm.port",
                  "port_distance": "farm.port_distance",
                  "journeys": "farm.installation_journeys",
                  "vessel_average_size":
                          "farm.installation_vessel_average_size",
                  ...
                  "total_times":
                       "farm.total_installation_time",
                  "installation_bom": "farm.installation_economics_data",
