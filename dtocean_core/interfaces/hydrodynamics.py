...
class HydroInterface(ModuleInterface):
    ...
    def declare_inputs(cls):
        ...
        input_list  =  ['bathymetry.layers',
                        ...
                        MaskVariable("farm.tidal_occurrence_nbins",
                                     "device.system_type",
                                     ["Tidal Fixed", "Tidal Floating"]),
    ...
    def declare_id_map(cls):
        ...
        id_map = {
                    "AEP_array": "farm.annual_energy",
                    "AEP_per_device": "farm.annual_energy_per_device",
                    ...
                    "n_bodies": "farm.number_of_devices",
                    ...
                    "pow_hist_per_device": "farm.mean_power_hist_per_device",
                    "q_factor_array": "farm.q_factor",
                    "q_factor_per_device": "farm.q_factor_per_device",
                    "rated_array_power": "farm.rated_power",
                    ...
                    "tidal_nbins": "farm.tidal_occurrence_nbins",
