...
class ConstraintsTool(Tool):
    ...
    def declare_id_map(cls):
        ...
        id_map = {
         ...
         'max_soil_res': 'bathymetry.max_soil_resistivity',
         'max_surf_current': 'farm.max_surface_current_10_year',
         'max_temp': 'bathymetry.max_seabed_temp',
         'max_voltage': 'farm.voltage_limit_max',
         'mean_power_hist_per_device': 'farm.mean_power_hist_per_device',
         ...
         'onshore_infrastructure_cost': 'farm.onshore_infrastructure_cost',
