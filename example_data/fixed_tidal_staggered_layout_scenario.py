...
wakeampfactorcyl = [[0.0, 0.65, 1.05],
                    [0.0, 2.0, 2.0],
                    [5.0, 0.4, 0.8],
                    [10.0, 0.78, 1.3],
                    [15.0, 1.07, 1.4],
...
winddragcoefrect = [[0.0, 0.0, 1.0, 2.0, 4.0, 6.0, 10.0, 20.0],
...
subgradereaccoef = [[0.0, 35.0, 50.0, 65.0, 85.0],
...
test_data = {
        ...
        "bathymetry.line_bearing_capacity_factor": line_bcf,
        ...
        "bathymetry.pile_skin_friction_end_bearing_capacity": pilefricresnoncal,
        "bathymetry.soil_cohesionless_reaction_coefficient": subgradereaccoef,
        "bathymetry.soil_cohesive_reaction_coefficient": k1coeff,
        ...
        "component.equipment_gradient_constraint": equipment_gradient_constraint,
        ...
        "device.umbilical_safety_factor": umbilical_safety,
        ...
        "device.foundation_safety_factor": found_safety,
        ...
        "farm.ac_power_flow": ac_power_flow,
        "farm.blockage_ratio": blockage_ratio,
        "farm.control_signal_cable": control_signal_cable,
        "farm.control_signal_channels": control_signal_channels,
        "farm.control_signal_type": control_signal_type,
        ...
        "farm.target_burial_depth": target_burial_depth,
        "farm.tidal_occurrence_nbins": n_bins,
        "farm.tidal_occurrence_point": tidal_point,
        "farm.tidal_series": tidal_series_raw,
        "farm.voltage_limit_max": max_voltage,
        "farm.voltage_limit_min": min_voltage,
        "farm.wave_direction_100_year": predominant_100year_wave_dir,
        "farm.current_profile": current_profile,
        "farm.grout_strength_safety_factor": grout_safety,
        ...
        "farm.hydro_underwater_noise_risk_weight" : hydro_underwater_noise_risk_weight,
        "farm.hydro_reserve_effect_weight" : hydro_reserve_effect_weight,
        "farm.hydro_reef_effect_weight" : hydro_reef_effect_weight,
        "farm.hydro_resting_place_weight" : hydro_resting_place_weight,
        "farm.initial_turbidity" : initial_turbidity,
        "farm.hydro_measured_turbidity" : hydro_measured_turbidity,
        "farm.initial_noise" : initial_noise,
        "farm.hydro_measured_noise" : hydro_measured_noise,
        "farm.elec_measured_noise" : elec_measured_noise,
        "farm.moor_measured_noise" : moor_measured_noise,
        "farm.fishery_restricted_area" : fishery_restricted_area,     
        "farm.initial_elec_field" : initial_elec_field,
        "farm.elec_measured_elec_field" : elec_measured_elec_field,
        "farm.initial_magnetic_field" : initial_magnetic_field,
        "farm.elec_measured_magnetic_field" : elec_measured_magnetic_field,
        "farm.initial_temperature" : initial_temeprature,
        "farm.elec_measured_temperature" : elec_measured_temperature,
