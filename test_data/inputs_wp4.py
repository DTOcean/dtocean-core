...
test_data = {'constants.line_bearing_capacity_factor': linebcf,
             ...
             'farm.grout_strength_safety_factor': groutsf,
             'farm.layout': layout,
             ...
             'component.predefined_mooring_list' : preline,
             'component.fabrication_cost' : fabcost,
#             "farm.fex" : fex,
             "farm.substation_props" : substparams,
             'farm.substation_layout': raw_origin_dict,
             'farm.substation_cog': raw_cog_dict,
             'farm.substation_foundation_location': raw_found_dict,
             "farm.umbilical_seabed_connection" : seabed_connection,
